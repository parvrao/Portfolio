  ...
  return (
    <div style={{ marginBottom: 20 }}>
      ...
      <div style={{ height: 3, background: 'var(--border)', borderRadius: 2, overflow: 'hidden' }}>
        <div style={{ height: '100%', width: `${(level / 5) * 100}%`, background: 'var(--accent)', borderRadius: 2, transition: 'width 0.8s ease' }} />
      </div>
    </div>
  );
}
      ...
      <section style={{ padding: 'var(--section-gap) 0' }}>
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(320px, 1fr))', gap: 2, marginBottom: 64 }}>
            ...
            <SkillGroup title="Supply Chain & Operations" items={skills.supplyChain} color="var(--blue)" />
            <SkillGroup title="Strategy & Consulting" items={skills.strategy} color="var(--amber)" />
          </div>
