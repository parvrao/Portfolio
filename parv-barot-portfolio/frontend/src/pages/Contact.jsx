      ...
      <section style={{ padding: 'var(--section-gap) 0' }}>
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'start' }}>
            <div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                {[
                  ...
                  { label: 'LinkedIn', value: 'linkedin.com/in/parvbarot', href: 'https://linkedin.com/in/parvbarot', color: 'var(--accent)' },
                  { label: 'GitHub', value: 'github.com/parvbarot', href: 'https://github.com/parvbarot', color: 'var(--accent)' },
                  { label: 'Location', value: 'Riverside, CA — open to relocation', href: null, color: 'var(--accent)' },
                  { label: 'Phone', value: '(929) 247-0593', href: 'tel:9292470593', color: 'var(--accent)' },
                ].map(c => (
                  <div key={c.label} style={{ background: 'var(--bg2)', border: '1px solid var(--border)', padding: '20px 24px', borderRadius: 0, display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 12 }}>
                    <div>
            ...
            <div style={{ background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: 0, padding: 40 }}>
              ...
              {[
                ...
                { role: 'Supply Chain Analyst', desc: 'Demand planning, inventory optimization, S&OP, logistics performance', color: 'var(--accent)' },
                { role: 'Strategy / Management Consultant', desc: 'Hypothesis-driven problem solving, client deliverables, transformation roadmaps', color: 'var(--accent)' },
              ].map((r, i) => (
              ...
              <a
                ...
                style={{
                  ...
                  padding: '14px 24px', background: 'var(--accent)', color: '#ffffff',
