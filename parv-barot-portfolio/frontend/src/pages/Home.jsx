...
const colorMap = {
  green:  { tag: 'tag-green',  hex: '#3a7d44' },
  blue:   { tag: 'tag-blue',   hex: '#2e5fa3' },
  amber:  { tag: 'tag-amber',  hex: '#b5651d' },
  coral:  { tag: 'tag-coral',  hex: '#c0392b' },
  purple: { tag: 'tag-purple', hex: '#6c3483' },
};
                ...
                <Link key={p.id} to={`/projects/${p.id}`} style={{ display: 'block', textDecoration: 'none' }}>
                  <div style={{
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 16 }}>
                      <span style={{ fontFamily: 'var(--font-display)', fontSize: 40, fontWeight: 800, color: 'var(--text3)', lineHeight: 1, opacity: 0.4 }}>{p.number}</span>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingTop: 16, borderTop: '1px solid var(--border)' }}>
                      <div>
                        <div style={{ fontSize: 20, fontFamily: 'var(--font-display)', fontWeight: 800, color: c.hex }}>{p.heroStat}</div>
                        <div style={{ fontSize: 11, color: 'var(--text3)', maxWidth: 160, lineHeight: 1.3 }}>{p.heroLabel}</div>
                      </div>
                      <span style={{ fontFamily: 'var(--font-display)', fontSize: 11, fontWeight: 700, color: c.hex, letterSpacing: '0.05em' }}>View →</span>
                    </div>
                  </div>
                </Link>
              );
