      ...
      <section style={{ padding: '80px 0', borderBottom: '1px solid var(--border)', background: 'var(--bg2)' }}>
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'start' }}>
            ...
            <div>
              {/* UCR Card */}
              <div style={{ background: 'var(--bg3)', border: '1px solid var(--border)', borderRadius: 8, padding: 28, marginBottom: 16 }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 16 }}>
                  ...
                  <span className="tag tag-green">Expected Jun 2026</span>
                </div>
                ...
                <div style={{ marginTop: 16, paddingTop: 16, borderTop: '1px solid var(--border)' }}>
                  ...
                  <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
                    {['Business Analytics', 'Supply Chain Mgmt', 'Financial Modeling', 'Marketing Strategy', 'Operations Strategy', 'Change Management'].map(c => (
                      <span key={c} style={{ fontSize: 10, padding: '3px 8px', border: '1px solid var(--border)', borderRadius: 2, color: 'var(--text3)', fontFamily: 'var(--font-display)', letterSpacing: '0.05em' }}>{c}</span>
                    ))}
                  </div>
                </div>
              </div>
              ...
              {/* Cert */}
              <div style={{ background: 'var(--bg3)', border: '1px solid var(--border)', borderRadius: 8, padding: 20 }}>
